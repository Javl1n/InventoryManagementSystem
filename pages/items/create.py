...
from components.items import create
from components import navigation, table

class ItemsCreate(CTkFrame):
    def __init__(self, master, controller, **kwargs):
        ...
        add_item = CTkButton(self, text="Go back", command=lambda: self.controller.navigate('/items')).place(y=35, x=1190, anchor="center")
