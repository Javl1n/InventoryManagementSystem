...
from components.movements.moveIn import create
from components import navigation, table

class ItemsInCreate(CTkFrame):
    def __init__(self, master, controller, **kwargs):
        ...
        title = CTkLabel(self, text="ADD MOVEMENT: IN", font=("default", 32, "bold")).place(y=35, x=220, anchor="w")
